...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; A value from the range (0..100), in increasing opacity, which describe
