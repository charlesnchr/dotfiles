...
local GET_pomodoro_CMD = "/home/cc/bin/pomo clock"
local PAUSE_pomodoro_CMD = "/home/cc/bin/pomo pause"
local START_pomodoro_CMD = "/home/cc/bin/pomo start"
local STOP_pomodoro_CMD = "/home/cc/bin/pomo stop"
...
pomodoroarc:connect_signal("button::press", function(_, _, _, button)
    if (button == 1) then awful.spawn(PAUSE_pomodoro_CMD, false)
    elseif (button == 2) then awful.spawn(START_pomodoro_CMD, false)
