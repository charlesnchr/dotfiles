...
-- Set colorscheme (auto-switching temporarily disabled, always dark)
...
-- Auto dark mode setup (temporarily disabled)
...
-- Treesitter is now configured in plugins/coding.lua via lazy.nvim opts
